...
For a step-by-step walkthrough from install to first device polled (about 10 minutes), see [docs/quickstart.md](docs/quickstart.md). After install, run through [docs/post-deploy-checklist.md](docs/post-deploy-checklist.md) — a 5-minute smoke test that confirms notifications, audit logging, backups, HTTPS, and the update channel are wired correctly.
...
- **[Post-Deploy Checklist](docs/post-deploy-checklist.md)** — 5-minute smoke test after install
